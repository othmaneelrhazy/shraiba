...
const products = [
  ...
  },
  {
    ...
    desc: "طين أحمر طبيعي 100%، يُستخرج من مصادر طبيعية ويُستخدم منذ قرون في العناية الطبيعية والحرف التقليدية. قوام ناعم ولون أحمر غني، مناسب للاستعمالات المتعددة.",
...
في حال استخدامه للعناية بالبشرة، يُنصح بإجراء اختبار على جزء صغير من الجلد أولًا للتأكد من ملاءمته، والتوقف عن استخدامه عند ظهور أي تهيج.`,
    price: 0, oldPrice: 0, rating: "5.0", sold: 0, stock: 0, badge: "جديد",
